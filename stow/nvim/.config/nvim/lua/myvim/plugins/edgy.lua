return {
  -- Plugin to create and manage predefined window layouts.
  -- Predefine where windows should appear, based on filetype.
  -- used by other applications.
  {
    ...
    opts = function()
      local opts = {
        bottom = {
          ...
          { ft = "qf", title = "QuickFix" },
          {
            ft = "help",
            size = { height = 20 },
            -- Don't open help files in edgy being edited.
            filter = function(buf)
      ...
      -- Not using `neo-tree`, thus can comment out below.
      -- Leaving in case using `neo-tree` in future.
