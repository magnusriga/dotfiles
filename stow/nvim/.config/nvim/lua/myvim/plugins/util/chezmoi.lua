local pick_chezmoi = function()
  if MyVim.pick.picker.name == "telescope" then
    require("telescope").extensions.chezmoi.find_files()
  elseif MyVim.pick.picker.name == "fzf" then
  ...
  elseif MyVim.pick.picker.name == "snacks" then
...
return {
  ...
  -- Not using `nvimdev/dashboard-nvim`.
  -- {
  ...
  -- Filetype icons, from `mini.icons`.
  {
