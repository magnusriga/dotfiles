...
vim.cmd([[
  ...
  highlight FloatTitle guifg=#98c379 guibg=#1e2030
...
-- LSP.
vim.cmd([[
  highlight @lsp.type.class guifg=#65bcff
]])

-- Diagnostics.
vim.cmd([[
  highlight DiagnosticUnderlineError cterm=undercurl gui=undercurl guibg=None guisp=#C53B53
]])
...
-- `TreesitterContextLineNumbers`     : Background and foreground color of line numbers in context area, default `LineNr`.
...
vim.cmd([[
  ...
  highlight! link RenderMarkdownCodeInline @markup.raw.markdown_inline
  highlight @markup.raw.markdown_inline guifg=#e06c75 guibg=#1b1c22 
  ...
  " Flipping 1 and 2.
  highlight RenderMarkdownH1 cterm=bold gui=bold guifg=#ffc777 guibg=#38343D
  highlight @markup.heading.1.markdown cterm=bold gui=bold guifg=#ffc777 guibg=#38343D
  highlight RenderMarkdownH1Bg cterm=bold gui=bold guifg=#ffc777 guibg=#38343D
  highlight RenderMarkdownH2 cterm=bold gui=bold guifg=#82AAFF guibg=#1F2336
  highlight @markup.heading.2.markdown cterm=bold gui=bold guifg=#82AAFF guibg=#1F2336
  highlight RenderMarkdownH2Bg cterm=bold gui=bold guifg=#82AAFF guibg=#1F2336
...
--   -- Normal = { fg = "#ffffff", bg = "#222436" },
--   -- Normal = { fg = "#d8dee9", bg = "#222436" },
